...
func (m *PostMutation) MarkdownContent() (r string, exists bool) {
...
// OldMarkdownContent returns the old "markdown_content" field's value of the Post entity.
// If the Post object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PostMutation) OldMarkdownContent(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) SetEncryptionKey(b []byte) {
	m.encryption_key = &b
}

// EncryptionKey returns the value of the "encryption_key" field in the mutation.
func (m *UserMutation) EncryptionKey() (r []byte, exists bool) {
	v := m.encryption_key
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldEncryptionKey(ctx context.Context) (v []byte, err error) {
	if !m.op.Is(OpUpdateOne) {
